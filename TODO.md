...
- [x] **perfo-budget-2026 — curva CPA harmônica + fontes** — redistribuição Aug-Dez ($80/$76/$71/$66/$60), maio ancorado em $195.37 real (BW BR - CPL x Mes l Interno), Open Items com dados reais de consumo (R$16.1MM) e saldo (R$13.3M). Distribuição Sheets row 5/12/14 atualizados · *27/05/2026*
- [x] **Atualizar distribuição de orçamento com dados do Diego** — Inv. USD de Mai-Dez escritos na planilha. Taxa R$5.56/USD · *26/05/2026*
- [x] **The Dashboard — prototype pacing BR** — `pacing.html` enviado ao Itirapina · *26/05/2026*
- [x] **Ana — ADM autorizada** — R$8K/mês; outros canais (Braga, futebolísticos) confirmados como influs, aguardam Gi para decisão final · *26/05/2026*
